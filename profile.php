...
if(isset($_POST['updateProfile'])){
    ...
    if(trim($_POST['username'], " ") != ""){
        ...
        if(mysqli_query($conn, $updateUserInfo)){
            ...
            echo "Something went wrong changing username :(";
        }
    }
    ...
    if(trim($_POST['email'], " ") != ""){
        ...
        if(mysqli_query($conn, $updateUserInfo)){
            ...
            echo "Something went wrong changing email :(";
        }
    }
}
?>
...
body {
    text-align: center;
    background-image: url('https://ichef.bbci.co.uk/news/976/cpsprodpb/15D1B/production/_90617398_ostrich.jpg');
